...
///
/// Additionally, by encapsulating the conditional logic in this object, additional processing can be performed for all conditionos, such as debug logging.
///
internal struct SuccinctCondition {
    /// The condition to evaluate against a UIView which will return an EvaluationResult which indicates if the condition was successful or not, and if not, why.

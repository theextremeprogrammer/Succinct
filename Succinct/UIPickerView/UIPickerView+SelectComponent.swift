...
extension UIPickerView {
    ...
    ///
    @objc internal func selectRow(withExactText searchText: String) {
    ...
    /// - Parameter withExactText: Text to compare to the text value of each row for the specified column.
    ///
    @objc internal func selectRow(columnIndex: Int, withExactText searchText: String) {
    ...
    ///
    @objc internal func hasRow(withExactText searchText: String) -> Bool {
    ...
    /// - Returns: A boolean value indicating if the specified search text was found or not.
    ///
    @objc internal func hasSelectedRow(withExactText searchText: String) -> Bool {
        for columnIndex in 0..<numberOfComponents {
